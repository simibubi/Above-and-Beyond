...
onEvent('item.registry', event => {
	...
	profession("Fishing", 0x9DDFD3, 0xDBF6E9, [
		...
		{ in: AC('atlantic_herring', quota), out: S(6) },
		{ in: AC('synodontis', quota), out: S(6) },
		{ in: AC('bluegill', quota), out: S(6) },
		{ in: AC('perch', quota), out: S(6) },
		{ in: AC('tambaqui', quota), out: S(6) },
		{ in: AC('minnow', quota), out: S(8) },
		{ in: AC('blackfish', quota), out: S(8) },
		{ in: AC('pink_salmon', quota), out: S(10) },
		{ in: AC('brown_trout', quota), out: S(10) },
		{ in: AC('carp', quota), out: S(10) },
		{ in: AC('pollock', quota), out: S(10) },
		{ in: AC('smallmouth_bass', quota), out: S(10) },
		{ in: AC('boulti', quota), out: S(10) },
		{ in: AC('red_shrooma', quota), out: S(10) },
		{ in: AC('brown_shrooma', quota), out: S(10) },
		{ in: AC('gar', quota), out: S(13) },
		{ in: AC('rainbow_trout', quota), out: S(13) },
		{ in: AC('bayad', quota), out: S(13) },
		{ in: AC('piranha', quota), out: S(13) },
		{ in: AC('jellyfish', quota), out: S(13) },
		{ in: AC('red_grouper', quota), out: S(13) },
		{ in: AC('atlantic_cod', quota), out: S(13) },
		{ in: AC('muskellunge', quota), out: S(15) },
		{ in: AC('pacific_halibut', quota), out: S(15) },
		{ in: AC('atlantic_halibut', quota), out: S(15) },
		{ in: AC('catfish', quota), out: S(20) },
		{ in: AC('capitaine', quota), out: S(20) },
		{ in: AC('tuna', quota), out: S(20) },
		{ in: AC('arapaima', quota), out: S(20) },
		{ in: AC('arrau_turtle', quota), out: S(20) },
		{ in: AC('box_turtle', quota), out: S(20) },
		{ in: AC('starshell_turtle', quota), out: S(20) },
		{ in: AC('goldfish', quota), out: S(20) },
		{ in: AC('neptunium_ingot', 5), out: S(32) }
	])
